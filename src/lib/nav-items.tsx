...
// Flat list for bottom tabs (mobile) — 5 most important
export const mobileTabItems: NavItem[] = [
  navGroups[0].items![0], // Dashboard
  navGroups[1].subGroups![0].items[0], // FX Stables
  navGroups[2].items![0], // Third Party (Swap & Send)
  navGroups[3].items![0], // Settlements
  navGroups[4].items![0], // Reports
];
