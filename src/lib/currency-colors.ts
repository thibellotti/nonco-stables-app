// Nonco brand currency colors — aligned with nonco.com design system
...
export const currencyColors: Record<string, { bg: string; text: string; border: string }> = {
  ...
  MXN: { bg: "rgba(199,255,16,0.1)", text: "var(--green)", border: "#c7ff10" },
  USDT: { bg: "rgba(161,36,248,0.1)", text: "var(--purple)", border: "#a124f8" },
  USDC: { bg: "rgba(99,102,241,0.1)", text: "#6366f1", border: "#6366f1" },
  GBP: { bg: "rgba(249,226,32,0.1)", text: "var(--amber)", border: "#f9e220" },
